//import 'package:detail/instructor/instructor.dart';
import 'package:detail/instructor/instructor_detail.dart';
import 'package:detail/instructor/intructor.dart';
    ...
    return GestureDetector(
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) =>
                  InstructorDetails(selectedInstructor: instructor)));
        },
        child: Padding(
